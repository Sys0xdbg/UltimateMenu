...
Do not mark the port fully verified until every applicable control has an observed result. The automated Lua mock and DLL build cover loading and API calls, not GTA Online outcomes.
